...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            <li><a href="{{ route('dashboard') }}"><i class="zmdi zmdi-delicious"></i><span>Dashboard</span> </a></li>
            <li><a href="{{ route('data-petugas') }}"><i class="zmdi zmdi-delicious"></i><span>Petugas</span> </a></li>
        </ul>
    </div>
    <!-- #Menu --> 
</aside>
